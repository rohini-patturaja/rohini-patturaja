...
- Analyzed large-scale email engagement data to uncover user behavior patterns  
- Built **predictive models** to optimize audience targeting and campaign effectiveness  
- Designed interactive dashboards to visualize key engagement metrics  
- Achieved a **225% increase in expected click-through rates** through data-driven optimization  

### 💖 [Heart Analysis Prediction](https://github.com/rohini-patturaja/Heart-Analysis-Prediction)  
- Built a **machine learning model in Python** to predict heart disease using clinical data  
- Performed data preprocessing, exploratory data analysis, and feature engineering  
- Evaluated multiple models to identify the most accurate and reliable predictions 
